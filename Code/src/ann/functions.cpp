...
double_tensor calc_classifcation_metrics(ulong_tensor y_true,
  ...
  // std::cout << "pred_per_class: " << pred_per_class << std::endl;

  // std::cout << "Precision per class: ";
  // for (const auto& val : prec_per_class) {
  //   std::cout << val << " ";
  // }
  // std::cout << std::endl;

  // std::cout << "Recall per class: ";
  // for (const auto& val : recall_per_class) {
  //   std::cout << val << " ";
  // }
  // std::cout << std::endl;
  ...
  // std::cout << "F1 measures: ";
  // for (const auto& val : f1_measures) {
  //   std::cout << val << " ";
  // }
  // std::cout << std::endl;
  // std::cout << "lookup: ";
