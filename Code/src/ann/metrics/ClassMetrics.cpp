...
ClassMetrics::ClassMetrics(const ClassMetrics& orig)
    : IMetrics(orig.m_nOutputs) {
...
double_tensor ClassMetrics::calculate_metrics(double_tensor y_true,
                                              double_tensor y_pred) {
